...
export function setActivityDefinitionProperty(
...
export function setActivityModelProperty(
...
export function getOrCreateProperty(
  ...
  if (!property) {
    ...
    property = { name: name, expressions: expressions, syntax: defaultSyntax?.() || null }
