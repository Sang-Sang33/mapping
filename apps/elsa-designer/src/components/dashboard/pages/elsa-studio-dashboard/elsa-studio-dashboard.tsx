...
export class ElsaStudioDashboard {
  ...
  @Prop({attribute: 'base-path', reflect: true}) basePath = '';
  ...
  render() {
    ...
    const menuItems = (this.dashboardMenu.data != null ? this.dashboardMenu.data.menuItems : [])
      .map(([route, label]) =>
    ...
    const routes = this.dashboardMenu.data != null ? this.dashboardMenu.data.routes : [];
