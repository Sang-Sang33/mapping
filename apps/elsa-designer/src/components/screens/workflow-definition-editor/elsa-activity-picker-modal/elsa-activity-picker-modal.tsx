...
import {
  ActivityDescriptor,
  ActivityDescriptorDisplayContext,
  ActivityTraits,
  EventTypes,
  VersionOptions
} from '../../../../models'
...
export class ElsaActivityPickerModal {
  ...
  async componentWillRender() {
    ...
    console.log(
      '🚀 ~ file: elsa-activity-picker-modal.tsx ~ line 34 ~ ElsaActivityPickerModal ~ componentWillRender ~ activityDescriptors',
      activityDescriptors
    )
    this.categories = [
      'All',
    ...
    console.log(
      '🚀 ~ file: elsa-activity-picker-modal.tsx ~ line 46 ~ ElsaActivityPickerModal ~ componentWillRender ~ filteredActivityDescriptors',
      filteredActivityDescriptors
    )
            ...
            <div class="elsa-flex">
              ...
              <div class="elsa-flex-1 elsa-pr-8">
                ...
                <div class="elsa-max-w-4xl elsa-mx-auto elsa-p-0">
                  {categories.map((category) => {
                    const displayContexts = filteredDisplayContexts.filter(
                      (x) => x.activityDescriptor.category == category
                    )
                          ...
                          {displayContexts.map((displayContext) => {
                            ...
                            return (
                              <a
                                ...
                                class="elsa-relative elsa-rounded elsa-group elsa-p-6 focus-within:elsa-ring-2 focus-within:elsa-ring-inset focus-within:elsa-ring-blue-500"
                              >
...
DashboardTunnel.injectProps(ElsaActivityPickerModal, ['culture'])
