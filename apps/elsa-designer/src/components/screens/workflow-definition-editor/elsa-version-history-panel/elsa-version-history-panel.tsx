...
export class ElsaVersionHistoryPanel {
  ...
  onDeleteVersionClick = async (e: Event, version: WorkflowDefinitionVersion) => {
    ...
    const result = await this.confirmDialog.show(
      'Delete Version',
      'Are you sure you wish to permanently delete this version? This operation cannot be undone.'
    )
                    ...
                    <table class="elsa-min-w-full elsa-divide-y elsa-divide-gray-300">
                      <thead class="elsa-bg-gray-50">
                        <tr>
                          <th
                            scope="col"
                            class="elsa-px-3 elsa-py-3.5 elsa-text-left elsa-text-sm elsa-font-semibold elsa-text-gray-900"
                          />
                          <th
                            scope="col"
                            class="elsa-py-3.5 elsa-pl-2 elsa-pr-3 elsa-text-left elsa-text-sm elsa-font-semibold elsa-text-gray-900"
                          >
                            {this.t('TableHeader.Version')}
                          </th>
                          <th
                            scope="col"
                            class="elsa-px-3 elsa-py-3.5 elsa-text-left elsa-text-sm elsa-font-semibold elsa-text-gray-900"
                          >
                            {this.t('TableHeader.Created')}
                          </th>
                          <th
                            scope="col"
                            class="elsa-relative elsa-py-3.5 elsa-pl-3 elsa-pr-4 sm:elsa-pr-6 lg:elsa-pr-8"
                          >
                            <span class="elsa-sr-only">{this.t('Buttons.View')}</span>
                          </th>
                      ...
                      <tbody class="elsa-divide-y elsa-divide-gray-200 elsa-bg-white">
                        {versions.map((v) => {
                          ...
                          const published = v.isPublished ? (
                            <div title="Published">
                              <svg
                                class="elsa-h-6 elsa-w-6 elsa-text-green-500"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke="currentColor"
                              >
                          ...
                          const revertIcon = (
                            <svg
                              class="elsa-h-6 elsa-w-6 elsa-text-gray-500"
                              width="24"
                              height="24"
                              viewBox="0 0 24 24"
                              stroke-width="2"
                          ...
                          const viewIcon = (
                            <svg
                              class="elsa-h-6 w-6 elsa-text-gray-500"
                              fill="none"
                              viewBox="0 0 24 24"
                              stroke="currentColor"
                            >
                          ...
                          return (
                            <tr class={rowCssClass}>
                              <td class="elsa-whitespace-nowrap elsa-px-3 elsa-py-4 elsa-text-sm elsa-text-gray-500">
                                {published}
                              </td>
                              <td class="elsa-whitespace-nowrap elsa-py-4 elsa-pl-2 elsa-pr-3 elsa-text-sm elsa-font-medium elsa-text-gray-900">
                                {v.version}
                              </td>
                              <td class="elsa-whitespace-nowrap elsa-px-3 elsa-py-4 elsa-text-sm elsa-text-gray-500">
                              ...
                              <td class="elsa-relative elsa-whitespace-nowrap elsa-py-4 elsa-pl-3 elsa-pr-4 elsa-text-right elsa-text-sm elsa-font-medium sm:elsa-pr-6 lg:elsa-pr-8">
                                <button
                                  onClick={(e) => this.onViewVersionClick(e, v)}
                                  type="button"
                                  disabled={isSelected}
...
Tunnel.injectProps(ElsaVersionHistoryPanel, ['serverUrl', 'culture'])
