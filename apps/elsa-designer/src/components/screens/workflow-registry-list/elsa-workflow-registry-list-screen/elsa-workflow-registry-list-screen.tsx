...
export class ElsaWorkflowRegistryListScreen {
  ...
  @State() private currentProviderName = "ProgrammaticWorkflowProvider";
  ...
  render() {
    ...
    const headers = this.workflowRegistryColumns.data != null ? this.workflowRegistryColumns.data.headers : [];
    const hasFeatureContextItems = this.workflowRegistryColumns.data != null ? this.workflowRegistryColumns.data.hasContextItems : false;
