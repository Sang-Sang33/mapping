        ...
        <div class="elsa-fixed elsa-z-10 elsa-inset-0 elsa-overflow-y-auto">
          <div class="elsa-flex elsa-items-end elsa-justify-center elsa-min-h-screen elsa-pt-4 elsa-px-4 elsa-pb-20 elsa-text-center sm:elsa-block sm:elsa-p-0">
            <div
              ...
              data-transition-enter-start="elsa-opacity-0"
              data-transition-enter-end="elsa-opacity-0"
              ...
              class="hidden elsa-fixed elsa-inset-0 elsa-transition-opacity"
              aria-hidden="true"
            >
...
DashboardTunnel.injectProps(ElsaModalDialog, ['culture'])
